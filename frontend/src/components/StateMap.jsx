...
<<<<<<< HEAD
      if (!clickedFeature || !clickedFeature.properties) {
        ...
        const geometry = clickedFeature.geometry; // Get geometry from the clicked state feature
        ...
        // Let's use the calculated zoom directly from fitBounds for a start
